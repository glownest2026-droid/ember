...
| `web/docs/CONSCIENTIOUS_CONOR.md` | Core parent persona and five-test quality bar. | Yes |
| `web/docs/PRODUCT_MARKETING_LIBRARY.md` | Product marketing names, pricing copy, and banned phrases. | Yes |
| `web/docs/brand/README.md` | Brand system map (personas, look, marketing, writing). | Yes |
| `web/docs/brand/PERSONAS.md` | Persona map (Conor, Thea). | Yes |
| `web/docs/brand/WRITING_GUIDELINES.md` | How every parent-facing sentence must sound. | Yes |

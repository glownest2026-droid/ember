...
export const SEED_MARKETPLACE_ITEM_TYPES: SeedItemType[] = [
  ...
  {
    slug: "potty_training_seat",
    label: "Potty training seat",
    aliases: [
      "potty",
      "potty chair",
      "potty training seat",
    ...
    risk_level: "medium",
    recommendation_policy: "recommendable",
    development_mappings: [m("toileting", "close")],
    safety_flags: [
      "Clean thoroughly before use",
      "Check stability and cracks",
      "Check manufacturer age guidance if shown",
      "Hygiene-sensitive item; buyer should inspect condition",
    ],
  },
  {
    slug: "baby_sleep_aid",

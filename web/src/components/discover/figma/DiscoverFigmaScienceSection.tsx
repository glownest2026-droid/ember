...
export function DiscoverFigmaScienceSection({ title, description }: { title: string; description: string }) {
      ...
      >
        <div className="flex items-start gap-3 lg:gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-base lg:text-xl font-medium text-[var(--ember-text-high)] mb-2 leading-tight">{title}</h3>

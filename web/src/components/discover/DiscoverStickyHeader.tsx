...
/**
 * Sticky header (global): logo, About, and signed-in nav or Join free.
 * [Logo] [Ember] [About] ... [Manage Family] [Sign out]  or  [Join free]
 */
        ...
        <div className="h-full mx-auto max-w-6xl px-4 sm:px-6 w-full">
          <div className="flex items-center justify-between gap-3 py-2 sm:gap-6">
            <div className="flex items-center gap-3 sm:gap-6 min-w-0">
              ...
              {user ? (
                <>
                  <Link href="/family" className="text-sm font-medium shrink-0 whitespace-nowrap" style={{ color: 'var(--ember-text-high)' }}>
                    Manage Family
                  </Link>
            ...
            <div className="flex items-center shrink-0 gap-3 sm:gap-6">
              {user ? (

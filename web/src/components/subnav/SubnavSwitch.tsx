...
export function SubnavSwitch({ checked, onCheckedChange, disabled, 'aria-label': ariaLabel }: SubnavSwitchProps) {
  ...
  return (
    <button
      ...
      className="cursor-pointer inline-flex h-[1.15rem] w-8 shrink-0 items-center rounded-full border border-transparent transition-colors outline-none focus-visible:ring-2 focus-visible:ring-[#B8432B] focus-visible:ring-offset-1 pointer-events-auto disabled:opacity-50 disabled:cursor-not-allowed"
      style={{

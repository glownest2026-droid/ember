...
| Specialist exemption | Explicit `evidence_exemption: specialist` + written reason | Brand fame alone / single 5★ with &lt;15 reviews |
...
| Public copy | Non-empty title/name, `product_description_under_30_words`, `ember_verdict` (Why Pip picked this) | Empty parent fields |

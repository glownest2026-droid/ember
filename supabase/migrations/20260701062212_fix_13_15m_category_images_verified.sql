...
-- cat_carry_something_small: deactivate (no storage object)
UPDATE public.pl_category_type_images
SET is_active = false
WHERE category_type_id = '6b5d0987-3539-4f18-8e6f-61f49cd95a69'
  AND age_band_id = '13-15m'
  AND is_active = true;
...
-- cat_big_paper_floor: deactivate (no storage object)
UPDATE public.pl_category_type_images
SET is_active = false
...
-- cat_stairs_climbing_check: deactivate (no storage object)
UPDATE public.pl_category_type_images
SET is_active = false
...
-- cat_same_ending_phrase: deactivate (no storage object)
UPDATE public.pl_category_type_images
SET is_active = false
...
-- cat_short_reconnects: deactivate (no storage object)
UPDATE public.pl_category_type_images
SET is_active = false
...
-- cat_everyday_sound_games: deactivate (no storage object)
UPDATE public.pl_category_type_images
SET is_active = false
...
-- cat_mini_jobs: deactivate (no storage object)
UPDATE public.pl_category_type_images
SET is_active = false
...
-- cat_tray_marks_food: deactivate (no storage object)
UPDATE public.pl_category_type_images
SET is_active = false

-- Wire v2 1–3m purchase-depth cards (ent_need_early_play) into Discover UI.
-- v2 import stored junction rows under ent_need_early_play, but
-- v_gateway_age_band_wrapper_needs_public did not map that need to any cluster.
...
WITH spine_v2_mapping (age_band_id, wrapper_slug, need_slug, need_rank) AS (
  VALUES
    ...
    ('1-3m', 'ent_cluster_listen_and_coo', 'ent_need_early_play', 3),
    ('1-3m', 'ent_cluster_watching_tracking', 'ent_need_visual_tracking', 1),
    ('1-3m', 'ent_cluster_watching_tracking', 'ent_need_early_play', 2),
    ('1-3m', 'ent_cluster_tummy_head_control', 'ent_need_tummy_head_control', 1),
    ('1-3m', 'ent_cluster_tummy_head_control', 'ent_need_early_play', 2),
    ...
    ('1-3m', 'ent_cluster_kicks_wriggles', 'ent_need_early_play', 4),
    ('1-3m', 'ent_cluster_first_grasps', 'ent_need_first_grasps', 1),
    ('1-3m', 'ent_cluster_first_grasps', 'ent_need_early_play', 2),

-- At home bridge (part 2): RPC + backfill using discover_have (enum committed in prior migration).
...
COMMENT ON FUNCTION public.sync_at_home_from_discover_have(UUID, UUID, BOOLEAN) IS
  'Sync Discover Stage 2 Have toggles into At home (garage_items).';

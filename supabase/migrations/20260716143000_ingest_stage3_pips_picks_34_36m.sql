...
WITH stage3_rows AS (
  ...
  FROM (VALUES
    ...
    ('cat_small_world_figures', 2, 2, 'visible', true, true, 'Best big open-ended scene', 'LEGO DUPLO 3in1 Tree House', 'LEGO DUPLO', 'Google Shopping', 'https://www.google.com/search?q=LEGO+DUPLO+3in1+Tree+House+10993&udm=28', NULL, 'Compare current prices', 'unknown', '3+', 'Large DUPLO tree-house set with people, animals, slide, garden and rebuildable scenes.', 'The richest story world here: several people, animals and places. Best where the family wants one bigger shared pretend-play set.', 'It supports whole scenes and can be rebuilt when the story changes.', 'Big footprint and higher price; borrow or buy pre-loved if unsure.', 'buy_or_borrow', true, 'A bigger family gift rather than a casual extra.', 'High duplicate risk if they already have DUPLO worlds.', 'Age 3+; check all pieces are present if bought pre-loved.', 'strong', ARRAY['https://www.google.com/search?q=LEGO+DUPLO+3in1+Tree+House+10993&udm=28'], 'shopping_search_link'),
    ('cat_small_world_figures', 3, 3, 'visible', true, true, 'Best animal story add-on', 'Schleich Farm World Starter Set', 'Schleich', 'Google Shopping', 'https://www.google.com/search?q=Schleich+Farm+World+Starter+Set&udm=28', NULL, 'Price not verified', 'unknown', 'not verified', 'Small set of realistic farm animal figures for open-ended animal stories.', 'Best when the family already has blocks, vehicles or a play mat and needs characters to make stories happen.', 'Animals can be added to existing play without buying a whole new world.', 'Check current UK availability and age guidance before buying.', 'buy_or_borrow', true, 'Good if it adds animals rather than more vehicles.', 'Medium duplicate risk.', 'Check age mark and small-part warnings on the current listing.', 'good', ARRAY['https://www.google.com/search?q=Schleich+Farm+World+Starter+Set&udm=28'], 'shopping_search_link'),
    ('cat_small_world_figures', 4, 4, 'visible', true, true, 'Best simple vehicle role play', 'PLAYMOBIL 1.2.3 Recycling Truck', 'PLAYMOBIL 1.2.3', 'Google Shopping', 'https://www.google.com/search?q=PLAYMOBIL+1.2.3+Recycling+Truck&udm=28', NULL, 'Price not verified', 'unknown', 'not verified', 'Toddler vehicle playset with recycling truck, figure and simple accessories.', 'A low-frustration vehicle scene: one person, one job, one truck. Good for children who build stories from everyday routines.', 'The job is easy to understand, so the story can come from the child.', 'Verify current UK stock and price before founder approval.', 'buy_or_borrow', true, 'Good gift for a child who likes real-life vehicles.', 'Medium duplicate risk if they already have service vehicles.', 'Check age mark and included pieces on the current listing.', 'good', ARRAY['https://www.google.com/search?q=PLAYMOBIL+1.2.3+Recycling+Truck&udm=28'], 'shopping_search_link'),
    ('cat_small_world_figures', 5, 5, 'visible', true, true, 'Best cosy town setup', 'ELC Happyland Village Set', 'Early Learning Centre Happyland', 'Google Shopping', 'https://www.google.com/search?q=ELC+Happyland+Village+Set&udm=28', NULL, 'Price not verified', 'unknown', 'not verified', 'Small-world village playset with people, buildings and everyday story props.', 'A classic if you want whole little-world play without building. Best for children who like moving people through everyday places.', 'It gives people and places immediately, which helps children act out small social stories.', 'Verify current listing before publishing beyond founder review.', 'buy_or_borrow', true, 'Good bigger gift if it fills a missing town-play gap.', 'High duplicate risk if they already have Happyland or similar.', 'Check current age mark and piece condition if pre-loved.', 'good', ARRAY['https://www.google.com/search?q=ELC+Happyland+Village+Set&udm=28'], 'shopping_search_link')

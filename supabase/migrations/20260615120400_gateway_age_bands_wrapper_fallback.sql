-- Allow gateway age bands to resolve from active wrapper mappings when pl_age_bands
-- metadata is missing (pilot imports still anchor on age_band_id in wrapper rankings).

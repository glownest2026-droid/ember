-- Restore full active age-band taxonomy on the slider (Expecting through older bands),
-- while keeping wrapper-only pilot bands (e.g. 6-9m) when pl_age_bands rows are absent.
